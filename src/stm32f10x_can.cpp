...
CAN::CAN(CAN_TypeDef* _CANx) :CANx(_CANx)
{
	this->Increase();
}
CAN::CAN(CAN_TypeDef* _CANx, InitTypeDef& InitStruct) : CANx(_CANx)
{
	this->Increase();
	this->Init(InitStruct);
}
CAN::CAN(CAN_TypeDef* _CANx, uint16_t Prescaler, uint8_t Mode, uint8_t SJW, uint8_t BS1, uint8_t BS2, FunctionalState TTCM, FunctionalState ABOM, FunctionalState AWUM, FunctionalState NART, FunctionalState RFLM, FunctionalState TXFP) : CANx(_CANx)
{
	this->Increase();
	CAN::InitTypeDef aaa;
...
CAN& CAN::operator<<(TxMsg& TxMessage)
{
	this->Transmit(TxMessage);
	return *this;
}
CAN_TypeDef* CAN::GetPeriphPointer(void)
{
	return this->CANx;
}
/**
...
void CAN::DeInit(void)
{
	...
	if(CANx == CAN1)
	{
		...
		RCC::APB1PeriphResetCmd(RCC_APB1Periph_CAN1, ENABLE);
		/* Release CAN1 from reset state */
		RCC::APB1PeriphResetCmd(RCC_APB1Periph_CAN1, DISABLE);
	}
	else
	{
		/* Enable CAN2 reset state */
		RCC::APB1PeriphResetCmd(RCC_APB1Periph_CAN2, ENABLE);
		/* Release CAN2 from reset state */
		RCC::APB1PeriphResetCmd(RCC_APB1Periph_CAN2, DISABLE);
	}
}
...
/**
  ...
  */
uint8_t CAN::Init(InitTypeDef &CAN_InitStruct)
{
	uint8_t InitStatus = CAN_InitStatus_Failed;
	uint32_t wait_ack = 0x00000000;
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.TTCM));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.ABOM));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.AWUM));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.NART));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.RFLM));
	assert_param(IS_FUNCTIONAL_STATE(CAN_InitStruct.TXFP));
	assert_param(IS_CAN_MODE(CAN_InitStruct.Mode));
	assert_param(IS_CAN_SJW(CAN_InitStruct.SJW));
	assert_param(IS_CAN_BS1(CAN_InitStruct.BS1));
	assert_param(IS_CAN_BS2(CAN_InitStruct.BS2));
	assert_param(IS_CAN_PRESCALER(CAN_InitStruct.Prescaler));
...
/**
  ...
  * @retval None.
  */
void CAN::Init(FilterInitTypeDef &CAN_FilterInitStruct)
{
...
/**
  ...
  * @retval None.
  */
void CAN::StructInit(InitTypeDef &CAN_InitStruct)
{
...
/**
  ...
  * @retval None.
  */
void CAN::SlaveStartBank(uint8_t BankNumber)
{
	/* Check the parameters */
	assert_param(IS_CAN_BANKNUMBER(BankNumber));
	...
	CAN1->FMR |= (uint32_t)(BankNumber)<<8;
...
/**
  ...
  * @retval None.
  */
void CAN::DBGFreeze(FunctionalState NewState)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
...
/**
  ...
  * @retval None
  */
void CAN::TTComModeCmd(FunctionalState NewState)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  */
uint8_t CAN::Transmit(TxMsg &TxMessage)
{
...
/**
  ...
  *         in an other case.
  */
uint8_t CAN::TransmitStatus(uint8_t TransmitMailbox)
{
	uint32_t state = 0;
...
/**
  ...
  * @retval None.
  */
void CAN::CancelTransmit(uint8_t Mailbox)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
...
/**
  ...
  * @retval None.
  */
void CAN::Receive(uint8_t FIFONumber, RxMsg &RxMessage)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
...
/**
  ...
  * @retval None.
  */
void CAN::FIFORelease(uint8_t FIFONumber)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
	assert_param(IS_CAN_FIFO(FIFONumber));
...
/**
  ...
  */
uint8_t CAN::MessagePending(uint8_t FIFONumber)
{
...
/**
  ...
  */
uint8_t CAN::OperatingModeRequest(uint8_t OperatingMode)
{
	...
	if(OperatingMode == CAN_OperatingMode_Initialization)
	{
		/* Request initialisation */
	...
	else  if(OperatingMode == CAN_OperatingMode_Normal)
	{
	...
	else  if(OperatingMode == CAN_OperatingMode_Sleep)
	{
		/* Request Sleep mode */
...
uint8_t CAN::GetLastErrorCode(void)
{
	uint8_t errorcode=0;
...
/**
  ...
  */
uint8_t CAN::GetReceiveErrorCounter(void)
{
	uint8_t counter=0;
...
/**
  ...
  */
uint8_t CAN::GetLSBTransmitErrorCounter(void)
{
	uint8_t counter=0;
...
/**
  ...
  * @retval None.
  */
void CAN::ITConfig(uint32_t CAN_IT, FunctionalState NewState)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
...
/**
  ...
  */
FlagStatus CAN::GetFlagStatus(uint32_t CAN_FLAG)
{
...
/**
  ...
  * @retval None.
  */
void CAN::ClearFlag(uint32_t CAN_FLAG)
{
	uint32_t flagtmp=0;
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
...
/**
  ...
  */
ITStatus CAN::GetITStatus(uint32_t CAN_IT)
{
...
/**
  ...
  * @retval None.
  */
void CAN::ClearITPendingBit(uint32_t CAN_IT)
{
	/* Check the parameters */
	assert_param(IS_CAN_ALL_PERIPH(CANx));
