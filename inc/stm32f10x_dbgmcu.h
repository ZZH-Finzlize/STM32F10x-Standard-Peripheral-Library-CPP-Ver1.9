...
class DBGMCU
{
	...
	protected:
	public:
		static uint32_t GetREVID(void);
		static uint32_t GetDEVID(void);
		static void Config(uint32_t DBGMCU_Periph, FunctionalState NewState);
		static DBGMCU_TypeDef* GetPeriphPointer(void);//获取内部外设指针
};
